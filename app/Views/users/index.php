              ...
              <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                  <div class="banner-img">
                    <a href="<?= base_url(); ?>/guru"><img src="/img/fg/g1.png" style="height: 70px;" alt=""></a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="card-statistic-4">
            <div class="align-items-center justify-content-between">
              <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                  <div class="banner-img">
                    <a href="<?= base_url(); ?>/siswa"><img src="/img/fg/g2.png" style="height: 70px;" alt=""></a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="card-statistic-4">
            <div class="align-items-center justify-content-between">
              <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                  <div class="banner-img">
                    <a href="<?= base_url(); ?>/kelas"><img src="/img/fg/g3.png" style="height: 70px;" alt=""></a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="card-statistic-4">
            <div class="align-items-center justify-content-between">
              <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                  <div class="banner-img">
                    <a href="<?= base_url(); ?>/mapel"><img src="/img/fg/g5.png" style="height: 70px;" alt=""></a>
                  </div>
                </div>
              </div>
            </div>
